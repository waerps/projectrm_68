...
import { Search, Heart, ShoppingCart, X, Trash2, BookOpen, ChevronRight } from "lucide-react"
...
export default function Navbar() {
  ...
  // โหลด courses ทั้งหมดครั้งเดียวตอนเริ่ม
  useEffect(() => {
  ...
  // คำนวณราคารวม (price เก็บเป็น "1200 บาท" ต้องแกะตัวเลขออก)
        ...
        <div className="flex items-center gap-2">
          ...
          {userData ? (
            <div className="relative group flex items-center gap-2">
              <div className={`flex items-center gap-1 cursor-pointer font-bold text-sm transition-colors pb-1 ${isActive("/profile") ? "text-orange-500 border-b-2 border-orange-500" : "text-gray-700 hover:text-orange-500"}`}>
